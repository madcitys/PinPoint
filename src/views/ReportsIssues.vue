<template>
  <div class="page">
    <div class="card">
      <p class="page-eyebrow">Reports &amp; Issues</p>
      <div class="page-header">
        <div class="page-header-copy">
          <h2>Reports &amp; Issues</h2>
          <p class="page-subtitle">Review reported issues and resolve flagged records</p>
        </div>
              ...
              <div ref="filterAnchor" class="filter-anchor">
                ...
                <div v-if="showFilterPopup" class="filter-popup" @click.stop>
                  ...
                  <div class="filter-group">
                    <label class="filter-option"><input type="checkbox" v-model="filterStatus.Resolved" /><span>Resolved</span></label>
                    <label class="filter-option"><input type="checkbox" v-model="filterStatus.Unresolved" /><span>Unresolved</span></label>
                  </div>
            ...
            <td>
              <div class="status-dropdown-wrap">
                <FancySelect
                  ...
                  variant="status"
                  @click.stop
                  @change="(value) => updateIssueStatus(row, value)"
                />
                <button
...
.status-dropdown.issue.unresolved {
