        ...
        <table>
          <thead>
            <tr>
              ...
              <th>Days Pending</th>
              <th>Assigned To</th>
              <th v-if="showActionColumn">Actions</th>
            </tr>
          </thead>
          <tbody>
            <tr
            ...
            >
              ...
              <td v-if="showActionColumn" class="actions-cell">
                ...
                <button
                  ...
                  type="button"
                  :disabled="actionBusyId === alert.id"
                  @click.stop="goToReports(alert)"
                >
                  {{ actionBusyId === alert.id ? 'Working...' : 'Go to Reports' }}
                </button>
...
const hasAssignedAlerts = computed(() => true);
...
const showActionColumn = computed(() => stateView.value !== 'resolved');
